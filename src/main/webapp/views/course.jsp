...
<main>
    ...
    <div class="container-fluid platform__container__wrapper">
        <div class="platform__container">
            ...
            <a href="courses" class="btn btn-primary" tabindex="-1"
               role="button">Список курсів</a>
            ...
            <div class="card cource__page">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">У цьому розділі відображається ваша оцінка</h6>

                    <c:choose>
                        <c:when test="${user.roleId==3}">
                            <h1>${course.points}</h1>
                        </c:when>
                        <c:when test="${usersByCourse.size()==0}">
                            <p>Поки що не можна виставити бали</p>
                        </c:when>
                        <c:otherwise>
                            <h5 class="card-title">Учні:</h5>
                            <div class="students">
                                <c:forEach items="${usersByCourse}" var="student">
                                    <div class="card profile__card">
                                        <svg width="50" height="50" class="rounded-circle me-2" version="1.1"
                                             id="Capa_1"
...
<path style="fill:#303C42;"
	...
	C389.056,459.557,326.161,490.667,256,490.667z"/>
                                            ...
                                            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="-33.5392"
                                                            y1="631.086"
                                                            x2="-28.0542" y2="625.6"
	...
	c58.816,0,106.667-47.852,106.667-106.667C362.667,154.26,342.841,121.229,313.184,102.263z"/>
                                            <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="-45.5784"
                                                            y1="639.555"
                                        ...
                                        <div class="student__point">
                                            <form action="course" method="post">
                                                ...
                                                <input name="courseId" type="hidden" value="${student.getCourse_id()}">
                                                <input name="points" type="text" class="form-control" id="firstName"
                                                       placeholder="Кількість балів"
                                                       value="${student.getPoints()}" required>
